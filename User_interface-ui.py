...
class QuizInterface():
    def __init__(self,quiz_brain: QuizBrain):
        ...
        self.window = Tk()
        self.window.title ="Quizzzzy"
        self.window.config(padx=20,pady=20,bg=THEME_COLOR)


        self.score_label = Label(text="Score:0",fg="white",bg=THEME_COLOR,font=("cambria",17))
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            #changing the state to disabled will prevent the button from being activated
